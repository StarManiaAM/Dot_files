...
# Configuration files
git clone git@github.com:StarManiaAM/Dot_files.git /tmp/Dot_files
mkdir -p .config/alacritty
cp /tmp/Dot_files/alacritty.toml ~/.config/alacritty
...
unzip /tmp/JetBrainsMono.zip -d /usr/local/share/fonts/ttf/JetBrainsMonoNerd
...
cp /tmp/Dot_files/nvim/lua/plugins/init.lua .config/nvim/lua/plugins/init.lua
cp /tmp/Dot_files/nvim/lua/core/init.lua .config/nvim/lua/core/init.lua
cp /tmp/Dot_files/nvim/lua/core/default_config.lua .config/nvim/lua/core/default_config.lua
